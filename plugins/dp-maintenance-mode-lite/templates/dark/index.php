...
<body id="top">
	...
	<!-- Start Container 12 -->
	<div id="main_content_border" class="container_12">
    	<div id="main_content">
            ...
            <div id="timer">
                <div class="container_clock">
                	<div class="grid_5">
                    	<h2 class="timer_widget_title"><?php echo $dpMaintenance['timer_widget_title']?></h2>
                    </div>
                ...
                <div class="container_12">
                    ...
                    <div class="grid_4">
                        ...
                        <div class="contactContent">
                        	<?php if($dpMaintenance['your_name'] == "") {
